# Garden Arena Reference-Matched Placement · Three.js v13

원화의 잔디 재질과 전체 명도를 맞춘 v10 바닥 위에서, 외곽 담장을 사각형 네 변의 직선 행·열로 다시 배치한 v13 브라우저 프리뷰다. 좌우 대칭, 중앙 전투 공간, 상·하단 게이트, 측면 포탈·폭포, 외곽 수로·담장·식생의 대응 위치를 기준으로 삼았다.

고정 공개 프리뷰: <https://naming-sense.github.io/lumina-garden-arena-preview/demo/?quality=mobile&v=13>
