# Garden Arena Reference-Matched Placement · Three.js v17
...
고정 공개 프리뷰: <https://naming-sense.github.io/lumina-garden-arena-preview/demo/?quality=mobile&v=17>
...
v17은 반복 배치되는 4종을 Blender 감면본으로 교체했다. 13개 GLB와 91개 인스턴스 기준 Tripo 메시 누적량은 2,359,679에서 953,795 rendered triangles로 내려간다. 나머지 고품질 원본은 보존했으며, 모바일 게임 투입 전에는 다음 단계로 나무/포탈 LOD, 단순 충돌체, 수로·폭포 전용 애니메이션 셰이더를 적용한다.

고유 소스 메시 자체는 합계 270,062 tris이며 같은 모델을 91번 배치해 953,795 tris가 된다. 교체한 네 반복 모듈은 꽃덤불 89,660, 직선 담장 35,800, 둥근 화단 95,046, 수로 24,530 tris로 합계 245,036(25.7%)이다. 이 수치는 바닥·글로우 효과·접지 그림자·그림자 패스는 제외한 Tripo 메시 인스턴스 합계라 실제 GPU 작업량은 더 클 수 있다.
